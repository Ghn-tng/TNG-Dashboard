    ...
    <div class="grid-2">
      ...
      <div style="width: 100%; margin-top: 8px;">
        <div class="map-container">
          ...
          <!-- === Province Glow Pins - tâm từng tỉnh === -->
          
          <!-- Gia Lai - tâm tỉnh xanh dương -->
          <div class="map-pin" style="top: 32%; left: 38%;" data-id="gialai" onclick="selectProvince('gialai')">
            <div class="pin-pulse"></div>
            <div class="pin-pulse2"></div>
            <div class="pin-dot"></div>
            <div class="pin-label" onclick="selectProvince('gialai')">GIA LAI</div>
          </div>
          
          <!-- Đắk Lắk - tâm tỉnh cam (Default Active) -->
          <div class="map-pin active-pin" style="top: 66%; left: 36%;" data-id="daklak" onclick="selectProvince('daklak')">
            <div class="pin-pulse"></div>
            <div class="pin-pulse2"></div>
            <div class="pin-dot"></div>
            <div class="pin-label" onclick="selectProvince('daklak')">ĐẮK LẮK</div>
          </div>
          
          <!-- Bình Định - tâm tỉnh xanh lá -->
          <div class="map-pin" style="top: 22%; left: 63%;" data-id="binhdinh" onclick="selectProvince('binhdinh')">
            <div class="pin-pulse"></div>
            <div class="pin-pulse2"></div>
            <div class="pin-dot"></div>
            <div class="pin-label" onclick="selectProvince('binhdinh')">BÌNH ĐỊNH</div>
          </div>
          
          <!-- Phú Yên - tâm tỉnh tím -->
          <div class="map-pin" style="top: 54%; left: 62%;" data-id="phuyen" onclick="selectProvince('phuyen')">
            <div class="pin-pulse"></div>
            <div class="pin-pulse2"></div>
            <div class="pin-dot"></div>
            <div class="pin-label" onclick="selectProvince('phuyen')">PHÚ YÊN</div>
          </div>

          <!-- === City Stars (⭐) tại thành phố thủ phủ === -->
          
          <!-- Pleiku -->
          <div class="city-star" style="top: 37%; left: 44%;">
            <div class="city-star-icon">⭐</div>
            <div class="city-star-name">Pleiku</div>
          </div>
          
          <!-- Buôn Ma Thuột -->
          <div class="city-star" style="top: 70%; left: 45%;">
            <div class="city-star-icon">⭐</div>
            <div class="city-star-name">Buôn Ma Thuột</div>
          </div>
          
          <!-- Quy Nhơn -->
          <div class="city-star" style="top: 34%; left: 69%;">
            <div class="city-star-icon">⭐</div>
            <div class="city-star-name">Quy Nhơn</div>
          </div>
          
          <!-- Tuy Hòa -->
          <div class="city-star" style="top: 58%; left: 69%;">
            <div class="city-star-icon">⭐</div>
